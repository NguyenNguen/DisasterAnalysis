# Disaster Social Media Analysis 🌪️📊
...
> **Đồ án môn học Lập trình Hướng đối tượng (IT3103)** - Đại học Bách Khoa Hà Nội. 
> 
...
* **❤️ Phân tích cảm xúc (Sentiment Analysis):** Theo dõi sự biến động tâm lý công chúng (Tích cực, Tiêu cực, Trung lập) theo các mốc thời gian (Giờ, Ngày, Tuần, Tháng).
* **🏚️ Phân loại thiệt hại (Damage Classification):** Tự động phân nhóm văn bản thành các hạng mục thiệt hại: Cơ sở hạ tầng, Nhà cửa, Tài sản cá nhân, Người bị ảnh hưởng, v.v.
